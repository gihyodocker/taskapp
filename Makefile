...
make-k8s-mysql-secret:
	...
	@cp ./k8s/plain/local/mysql-secret.yaml ./k8s/plain/okteto/mysql-secret.yaml
...
make-k8s-api-config:
	...
	@cp ./k8s/plain/local/api-config-secret.yaml ./k8s/plain/okteto/api-config-secret.yaml
